...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto ">
      <img id="mxc" src="./img/mxc.jpg" alt="Almajdouie">
      <h1 class="display-4 fw-normal">اربح معنا</h1>
      <p class="lead fw-normal">باقي على فتح التسجيل</p>
      <h3 color="red" id="countdown"></h3>
      <p class="lead fw-normal">للسحب على سيارة قيمة</p>
    </div>
...
<div class="container">
  ...
  <li class="list-group-item">الرابح سيحصل على سيارة قيمة من المجدوعي</li>
</ul>
</div>
</div>
